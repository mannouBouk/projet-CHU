 ...
 */
final class Version20220414093836 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE repa_regime_al (repa_id INT NOT NULL, regime_al_id INT NOT NULL, INDEX IDX_2185B10B5DEAEC1E (repa_id), INDEX IDX_2185B10B72C6ADE6 (regime_al_id), PRIMARY KEY(repa_id, regime_al_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE patient CHANGE nom nom VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE prenom prenom VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE regime regime VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
