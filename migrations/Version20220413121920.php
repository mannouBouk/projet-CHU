 ...
 */
final class Version20220413121920 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE regime_al_repa (regime_al_id INT NOT NULL, repa_id INT NOT NULL, INDEX IDX_72CA799772C6ADE6 (regime_al_id), INDEX IDX_72CA79975DEAEC1E (repa_id), PRIMARY KEY(regime_al_id, repa_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
