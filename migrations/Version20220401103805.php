 ...
 */
final class Version20220401103805 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        //  $this->addSql('ALTER TABLE user ADD roles LONGTEXT NOT NULL COLLATE `utf8mb4_unicode_ci` COMMENT \'(DC2Type:json)\', CHANGE username username VARCHAR(180) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE password password VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
    }
}
