 ...
 */
final class Version20220411133542 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE patient ADD service INT DEFAULT NULL, CHANGE nom nom VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE prenom prenom VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE nom_service nom_service VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
