 ...
 */
final class Version20220427125228 extends AbstractMigration
{
    ...
    {/*
        ...
        $this->addSql('ALTER TABLE user DROP rolee_id, DROP role_id');
    */
    }
    ...
    {/*
        ...
        $this->addSql('ALTER TABLE user ADD rolee_id INT DEFAULT NULL, ADD role_id INT NOT NULL');
