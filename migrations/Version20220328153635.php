 ...
 */
final class Version20220328153635 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        // $this->addSql('ALTER TABLE role DROP profilrole');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        //  $this->addSql('ALTER TABLE role ADD profilrole VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE label label VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE description description VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
