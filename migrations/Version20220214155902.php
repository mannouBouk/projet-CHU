 ...
 */
final class Version20220214155902 extends AbstractMigration
{
    ...
    {/*
        ...
        $this->addSql('CREATE TABLE profilrole (id INT AUTO_INCREMENT NOT NULL, ajouterutilisateur VARCHAR(255) NOT NULL, activutilisateur VARCHAR(255) NOT NULL, desactutilisateur TINYINT(1) NOT NULL, modifierutilisateur TINYINT(1) NOT NULL, ajouterservice TINYINT(1) NOT NULL, supprimerservice TINYINT(1) NOT NULL, modifierservice TINYINT(1) NOT NULL, ajouteregimesalimentaires TINYINT(1) NOT NULL, supprimerregimesalimentaires TINYINT(1) NOT NULL, ajouterpi TINYINT(1) NOT NULL, ajouterlespatients TINYINT(1) NOT NULL, activationoud�sactivationdespatients TINYINT(1) NOT NULL, ajouterregimesalimentairesp TINYINT(1) NOT NULL, ajouterprofilerole TINYINT(1) NOT NULL, modifierprofilerole TINYINT(1) NOT NULL, supprimerprofilerole TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
